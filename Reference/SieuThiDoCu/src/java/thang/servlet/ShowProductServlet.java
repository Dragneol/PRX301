...
public class ShowProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            products.getProduct().addAll(productDAO.getProductById(productId));
            StringWriter sw = new StringWriter();
            MyJAXBUltil.marshalling(products, sw);
            request.setAttribute("PRODUCT", sw.toString());
        } finally {
            RequestDispatcher rq = request.getRequestDispatcher(PRODUCT_PAGE);
