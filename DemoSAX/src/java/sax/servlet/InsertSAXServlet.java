...
import sax.parser.CrawlStudentHandler;
 ...
 * @author dragn
 */
public class InsertSAXServlet extends HttpServlet {
 private static final String xmlFile = "WEB-INF\\studentsAccount.xml";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CrawlStudentHandler saxObj = new CrawlStudentHandler();
            XMLUtils.parseFileWithSAX(filePath, saxObj);
            
        } catch (Exception e) {
            log("ERROR at Insert Servlet");
        } finally {
